...
def plot_training_history(history: List[Dict], save_dir: str) -> None:
    ...
    Vẽ biểu đồ training history:
        - Train Loss & Val Loss (BCEWithLogitsLoss)
        - val_ndcg@10
        - val_recall@10
        - val_hitrate@10
    """
    ...
    def _plot(ax, y_data, label, color, ylabel, title):
    ...
    # ── Panel 1: Train Loss ──────────────────────────────────────
    _plot(axes[0, 0], train_loss, "Train Loss", "#E15759", "Loss", "Train Loss")
...
def main() -> None:
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(
            ...
            f"val_precision@10={val_metrics['val_precision@10']:.4f} | "
